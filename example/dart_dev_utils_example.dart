...
void main() async{
  ...
  print(Constants.i.regExpCellPhoneBR.hasMatch('(21)985854628'));

  // Formatos: 0000000000; (00)00000000; 000000-0000; (00)0000-0000
  print(Constants.i.regExpFixePhoneBR.hasMatch('(21)85854628'));

  print('suebersson montalvão'.capitalizeAll);
